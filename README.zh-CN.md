...
2. 从[当前稳定版](https://github.com/CzRzChao/go2codex/releases/tag/v0.1.1)下载 ZIP 和校验文件，然后按照[下载并校验](#下载并校验)中的步骤完成校验。
...
设置页会在后台检测 `codex` 和 `claude`，不会打开终端窗口。短暂检测期间可能会运行你的 zsh、bash 或 fish 启动文件。
