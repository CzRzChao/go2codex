...
- `Go2Codex-0.1.0-preview.6-macos-arm64.zip`
- `Go2Codex-0.1.0-preview.6-macos-arm64.zip.sha256`

Download both files into the same directory and verify the archive before extracting it:

```sh
shasum -a 256 -c Go2Codex-0.1.0-preview.6-macos-arm64.zip.sha256
```
...
Scripts/package-github-release.sh --validate-only v0.1.0-preview.6
git tag -a v0.1.0-preview.6 -m "Go2Codex 0.1.0 preview 6"
